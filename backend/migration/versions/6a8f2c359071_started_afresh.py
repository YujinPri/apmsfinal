...
Revision ID: 6a8f2c359071
Revises: 
Create Date: 2023-09-14 18:49:30.118423
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_alumni_student_number'), 'alumni', ['student_number'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_alumni_student_number'), table_name='alumni')
