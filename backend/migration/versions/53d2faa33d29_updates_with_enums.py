...
Revision ID: 53d2faa33d29
Revises: 0d640c5c19f3
Create Date: 2023-09-14 14:58:03.759540
...
revision: str = '53d2faa33d29'
down_revision: Union[str, None] = '0d640c5c19f3'
...
def upgrade() -> None:
    ...
    sa.Column('area', sa.Enum('CURRICULUM', 'FACILITIES', 'FACULTY', 'LIBRARY', 'STUDENT_SERVICES', 'THE_CAMPUS', name='feedbackarea'), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('gross_monthly_income', sa.Enum('POOR', 'LOW_INCOME', 'LOWER_MIDDLE', 'MIDDLE_MIDDLE', 'UPPER_MIDDLE', 'UPPER_CLASS', 'RICH', name='monthlyincome'), nullable=True),
    sa.Column('employment_contract', sa.Enum('REGULAR', 'CASUAL', 'PROJECT', 'SEASONAL', 'FIXED_TERM', 'PROBATIONARY', name='employmentcontract'), nullable=True),
    sa.Column('job_level_position', sa.Enum('ENTRY_LEVEL', 'JUNIOR', 'MID_LEVEL', 'SENIOR', 'DIRECTOR', name='joblevelposition'), nullable=True),
    sa.Column('type_of_employer', sa.Enum('PUBLIC', 'PRIVATE', name='employertype'), nullable=True),
    sa.Column('location_of_employment', sa.Enum('PUBLIC', 'INTERNATIONAL', name='locationofemployment'), nullable=True),
    ...
    op.add_column('alumni', sa.Column('civil_status', sa.Enum('Single', 'Married', 'Divorced', 'Widowed'), nullable=True))
    op.add_column('alumni', sa.Column('sex', sa.Enum('MALE', 'FEMALE', 'PRIVATE', name='sex'), nullable=True))
    ...
    op.add_column('alumni', sa.Column('present_employment_status', sa.Enum('UNEMPLOYED', 'PART_TIME', 'FULL_TIME', name='employmentstatus'), nullable=True))
