...
const EditEmploymentModal = ({ open, onClose, employmentID }) => {
  ...
  const { data: cachedData, isLoading: isLoadingProfile } = useQuery("employment-profile-specific", getData);
  ...
  if (isLoadingJobs || isLoadingCities || isLoadingProfile) {
    return (
      <Dialog open={true}>
        <DialogTitle>
        ...
        <Grid container spacing={2} p={2}>
          ...
          >
            <Grid
              ...
              xs={7}
              style={{
                display: employmentProfile?.is_international ? "none" : "block",
              }}
            >
              <Autocomplete
                name="city"
