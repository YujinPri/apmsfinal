        ...
        >
          <Box>
            ...
            >
              <Avatar
                alt="Profile"
                src={profile.profile_picture} // Add a default profile image source
                ...
                {profile?.headline && (
                  <Typography
                    ...
                    sx={{
                      ...
                      padding: "0 1.5rem",
                      marginTop: "1rem",
                      maxWidth: "60ch", // Maximum width of 40 characters
            ...
            >
              ...
              <Chiptip
                ...
                label={
                  <Typography
                    sx={{
                      maxWidth: "15ch", // Maximum width of 40 characters
                      // whiteSpace: "wrap", // Prevent text from wrapping to the next line
                      overflow: "hidden", // Hide overflow text
                      textOverflow: "ellipsis", // Display ellipsis (...) when text overflows
                    }}
      ...
      return (
        <Grid
          ...
          sx={{
            display: "flex",
            flexDirection: "column",
            alignItems: "center", // Change "center" to "stretch"
            gap: 2,
            justifyContent: "center",
            position: "relative", // Add relative positioning to the container
            marginY: "2rem",
        ...
        >
          ...
          <Box
            sx={{
              display: "flex",
              justifyContent: "stretch", // Change "center" to "stretch"
              gap: 2,
              flexDirection: "column",
              width: "80%",
            }}
